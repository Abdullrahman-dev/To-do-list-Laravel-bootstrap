    ...
    <main class="flex-shrink-0 mt-5">
        <div class="container">
            ...
            <div class="my-3 p-3 bg-body rounded shadow-sm"> 
                <div class="mb-3">Welcome {{auth()->user()->name}}</div>
                <h6 class="border-bottom pb-2 mb-0">Tasks To Do :</h6> 
                    ...
                    <div class="pb-3 mb-0 small lh-sm border-bottom w-100"> 
                        <div class="d-flex justify-content-between"> 
                            ...
                            <div>
                                ...
                                <a href="{{route('task.edit',$task->id)}}" class="btn btn-primary"><svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-edit"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M7 7h-1a2 2 0 0 0 -2 2v9a2 2 0 0 0 2 2h9a2 2 0 0 0 2 -2v-1" /><path d="M20.385 6.585a2.1 2.1 0 0 0 -2.97 -2.97l-8.415 8.385v3h3l8.385 -8.415z" /><path d="M16 5l3 3" /></svg></a>
                            </div>
                        </div> 
